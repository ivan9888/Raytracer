            ...
            public void run() {
                ...
                if (closestIntersection != null) {
                    ...
                    for (Light light : lights) {
                        ...
                        boolean firstIntersectionIsRefrlection=true;
                        ...
                        if(closestIntersection.getObject().getLayers().isReflection() && !closestIntersection.getObject().getLayers().isRefraction()){
                            reflectColor=Raytracer.reflection(ray,closestIntersection,objects,
                                    new double[]{cameraZ + nearFarPlanes[0], cameraZ + nearFarPlanes[1]},firstIntersectionIsRefrlection,reflectColor1,light.getPosition());
                        }
